...
\centering
\includegraphics[width=5in]{figures/FigureS1}
\end{figure}
...
\centering
\includegraphics[width=5in]{figures/FigureS2}
\end{figure}

\begin{figure}
\caption{The break-even cost ratio for four values of the efficacy parameter $\rho$.}
\centering
\includegraphics[width=5in]{figures/FigureS3}
\end{figure}
...
\centering
\includegraphics[width=6.8in]{figures/FigureS7}
\end{figure}
