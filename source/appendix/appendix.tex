...
In addition to identifying opioid prescriptions in pharmacy claims, we also identified procedure codes for epidural or intraveneous opioid injections in all of the Medicaid claims. Table S9 lists these codes, which were identified by searching the descriptions of all HCPCS codes for each of the opioid ingredients in the Washington State prescribing guidelines used to identify prescription drugs.
...
\centering
\includegraphics[width=3.4in]{../../output/figures/Figure4.pdf}
\end{figure}

\begin{figure}
\caption{Odds ratios from the post-BOLASSO regression (Figure 1), using variables from Medicaid data only.}
\centering
\includegraphics[width=6.8in]{../../output/figures/FigureS2}
\end{figure}

\begin{figure}
\caption{The break-even cost ratio for three values of the effectiveness rate $\alpha$ (Figure 2), for Medicaid data only.}
\centering
\includegraphics[width=3.4in]{../../output/figures/FigureS3}
\end{figure}

\begin{figure}
\caption{The false discovery rate for minority status, incarceration history, and disability status (Figure 3), for Medicaid data only.}
\centering
\includegraphics[width=6.8in]{../../output/figures/FigureS4}
\end{figure}

%\begin{figure}
%\caption{The break-even cost ratio by cumulative risk decile for race/ethnicity, incarceration history, and disability status (Figure 4), for Medicaid data only.}
%\centering
