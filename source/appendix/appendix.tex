...
To estimate population-level characteristics of Medicaid enrollees in Rhode Island, we also constructed a second panel of longterm Medicaid enrollees. We included all enrollees who were enrolled for at least six out of 12 months in each of the five years between 2007 and 2011. This panel comprises 120,584 enrollees, who were enrolled with a median of 60 months (interquartile range of 59 to 60 months). 
...
\begin{table}
\caption{Population estimates for minorities vs. non-minorities.}
\begin{tabular}{lrr}
\em Group & \em Average days per month with a claim & \em Average median distance to providers \\[0.5em]
White & 5.62 & 25.18km \\
African-American & 4.79 & 19.64km \\
Hispanic & 4.34 & 17.56km
\end{tabular}
\end{table}
...
\begin{figure}
\caption{The break-even cost ratio by cumulative risk decile and for three values of the effectiveness rate $\alpha$ (Figure 1), for Medicaid data only.}
...
\begin{figure}
\caption{The false discovery rate by cumulative risk decile for race/ethnicity, incarceration history, and disability status (Figure 3), for Medicaid data only.}
...
\begin{figure}
\caption{The fraction of true outcomes by risk decile in the test sample. The vertical black line indicates the base rate of outcomes among the entire population, which is 0.057.}
