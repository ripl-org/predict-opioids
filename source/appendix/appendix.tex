...
Tramadol & 50.0 \\
\hline
\em Recovery Ingredient\textsuperscript{**} & Minimum Amount (mg) \\
Buprenorphine & 0.0 \\
Methadone & 0.0 \\
Naloxone & 0.0 \\
Naltrexone & 0.0 \\
...
{\footnotesize
\textsuperscript{*} Meperidine has no recommended starting dose for treatment of chronic pain because of its risk for complications in older adults; therefore, we consider any amount as evidence that the drug is an opioid.

\textsuperscript{**} We consider any amount of a recovery ingredient as evidence that the drug may have been used to treat a prior opioid use disorder.
}
