...
In addition to identifying opioid prescriptions in pharmacy claims, we also identified procedure codes for subdermal or intraveneous opioid injections in all of the Medicaid claims. Table S2 lists these codes, which were identified by searching the descriptions of all HCPCS codes for each of the opioid ingredients in the Washington State prescribing guidelines used to identify prescription drugs.
