...
\hline
\em Opioid Ingredient & Minimum Amount (mg) \\
Codeine & 30.0 \\
Fentanyl & 0.0125 \\
Hydrocodone & 5.0 \\
Hydromorphone & 2.0 \\
...
Tramadol & 50.0 \\
\hline
\em Recovery Ingredient° & Minimum Amount (mg) \\
Buprenorphine & 0.0 \\
Methadone & 0.0 \\
Naloxone & 0.0 \\
Naltrexone & 0.0 \\
...
\hbox{\footnotesize * Meperidine has no recommended starting dose for treatment of chronic pain because of its risk for complications in older adults; therefore, we consider any amount as evidence that the drug is an opioid.}
\hbox{\footnotesize ° We consider any amount of a recovery ingredient as evidence that the drug may have been used to treat a prior opioid use disorder.}
...
\hbox{\footnotesize * ICD-10 diagnosis code}
\hbox{\footnotesize ° HCPCS procedure code}
